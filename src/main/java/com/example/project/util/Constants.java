...
public class Constants {
	...
	public static final String RETRIEVE_USER_INITIATED = "Retrieved";
	public static final String RETRIEVE_USER_COMPLETED = "Retrieve completed";
	public static final String APPLICATION_RUNS_SUCCESSFULLY = "Application Runs";
